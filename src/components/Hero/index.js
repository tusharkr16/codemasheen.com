    ...
    <div className='flex flex-col lg:flex-row mt-2 lg:mt-6'>
      ...
      <div className='lg:w-1/2 lg:min-h-[80vh] lg:h-screen flex items-center justify-center flex-col order-2 lg:order-1'>
        ...
        <div className='flex gap-4 mt-4'>
          <button className='bg-blue-600 text-white px-6 py-2 rounded-full text-lg shadow-lg hover:bg-blue-700' onClick={handleContact}>
            Contact
          </button>
          <button className='border border-black px-6 py-2 rounded-full text-lg shadow-lg hover:bg-gray-100' onClick={handleAbout}>
            About
          </button>
        </div>
